...
```
mvn de.quantummaid:documaid:0.9.18:generate
mvn de.quantummaid:documaid:0.9.18:generate -DskipPaths=docs/Usage.md
...
```
mvn de.quantummaid:documaid:0.9.18:validate
```
