...
```
mvn de.quantummaid:documaid:0.9.20:generate
mvn de.quantummaid:documaid:0.9.20:generate -DskipPaths=docs/Usage.md
...
```
mvn de.quantummaid:documaid:0.9.20:validate
```
