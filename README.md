...
```
mvn de.quantummaid:documaid:0.9.17:generate
mvn de.quantummaid:documaid:0.9.17:generate -DskipPaths=docs/Usage.md
...
```
mvn de.quantummaid:documaid:0.9.17:validate
```
