...
```
mvn de.quantummaid:documaid:0.9.25:generate
mvn de.quantummaid:documaid:0.9.25:generate -DskipPaths=docs/Usage.md
...
```
mvn de.quantummaid:documaid:0.9.25:validate
```
