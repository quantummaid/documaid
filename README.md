...
```
mvn de.quantummaid:documaid:0.9.27:generate
mvn de.quantummaid:documaid:0.9.27:generate -DskipPaths=docs/Usage.md
...
```
mvn de.quantummaid:documaid:0.9.27:validate
```
