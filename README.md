...
```
mvn de.quantummaid:documaid:0.9.24:generate
mvn de.quantummaid:documaid:0.9.24:generate -DskipPaths=docs/Usage.md
...
```
mvn de.quantummaid:documaid:0.9.24:validate
```
