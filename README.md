...
```
mvn de.quantummaid:documaid:0.9.13:generate
mvn de.quantummaid:documaid:0.9.13:generate -DskipPaths=docs/Usage.md
...
```
mvn de.quantummaid:documaid:0.9.13:validate
```
