...
```
mvn de.quantummaid:documaid:0.9.33:generate
mvn de.quantummaid:documaid:0.9.33:generate -DskipPaths=docs/Usage.md
...
```
mvn de.quantummaid:documaid:0.9.33:validate
```
