...
```
mvn de.quantummaid:documaid:0.9.16:generate
mvn de.quantummaid:documaid:0.9.16:generate -DskipPaths=docs/Usage.md
...
```
mvn de.quantummaid:documaid:0.9.16:validate
```
