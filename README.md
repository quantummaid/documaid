...
```
mvn de.quantummaid:documaid:0.9.31:generate
mvn de.quantummaid:documaid:0.9.31:generate -DskipPaths=docs/Usage.md
...
```
mvn de.quantummaid:documaid:0.9.31:validate
```
