...
```
mvn de.quantummaid:documaid:0.9.23:generate
mvn de.quantummaid:documaid:0.9.23:generate -DskipPaths=docs/Usage.md
...
```
mvn de.quantummaid:documaid:0.9.23:validate
```
