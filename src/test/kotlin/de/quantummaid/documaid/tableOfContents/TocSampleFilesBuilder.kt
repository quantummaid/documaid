...
import de.quantummaid.documaid.shared.TestFileBuilder.Companion.aFile
import de.quantummaid.documaid.shared.TestStructureBuilder.Companion.aTestStructureIn
import java.nio.file.Path

class TocSampleFilesBuilder {

    companion object {
        fun aTocTagInReadmeAndMultipleMarkdownFilesInDocsDirectory(basePath: Path): Configurator {
            ...
            return object : Configurator {
                override fun invoke(
                    ...
                    """.trimIndent()
                    setupSteps.add {
                        val fileStructure = aTestStructureIn(baseDir)
                            .with(
                                aFile("README.md")
        ...
        fun aTocTagInReadmeFromSameDirectory(basePath: Path): Configurator {
        ...
        fun aTocTagInReadmeWithMultipleNestedDirectories(basePath: Path): Configurator {
        ...
        fun aTocTagInReadmeWithNotIndexedMarkdownFiles(basePath: Path): Configurator {
        ...
        fun aTocTagInReadmeWithGeneratedOverviewFile(basePath: Path): Configurator {
        ...
        fun aTocTagInReadmeWithTheSameIndexTwice(basePath: Path): Configurator {
        ...
        fun aTocTagInReadmeWithMissingIndex(basePath: Path): Configurator {
        ...
        fun aTocTagInReadmeWithTheSameIndexTwiceInSubDirectory(basePath: Path): Configurator {
        ...
        fun aTocTagInReadmeWithMissingIndexInSubDirectory(basePath: Path): Configurator {
        ...
        fun aTocTagInReadmeWithNotExistingScanDirectory(basePath: Path): Configurator {
        ...
        fun aTocTagInReadmeWithMalFormedOptions(basePath: Path): Configurator {
        ...
        fun aTocInReadmeWithCorrectToc(basePath: Path): Configurator {
        ...
        fun aTocInReadmeWithMissingToc(basePath: Path): Configurator {
        ...
        fun aTocInReadmeWithIncorrectToc(basePath: Path): Configurator {
