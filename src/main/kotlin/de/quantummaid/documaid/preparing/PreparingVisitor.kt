...
interface PreparingVisitor {
    ...
    fun afterDirectoryPreparing(directory: Directory, project: Project): List<VerificationError> {
        return emptyList()
    }

    fun prepareFile(file: ProjectFile, project: Project): List<VerificationError> {
        return emptyList()
    }

    fun finishPreparation(project: Project): List<VerificationError> {
        return emptyList()
    }
}
